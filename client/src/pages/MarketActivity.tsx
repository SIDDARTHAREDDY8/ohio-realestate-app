/*
 * Market Activity — county-level listing market activity from Redfin Market Tracker.
...
function cell(c: CountyMarket, key: SortKey): string {
  switch (key) {
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-3 border-b border-border">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Market Activity</h1>
