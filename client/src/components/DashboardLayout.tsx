...
import {
  ...
  GitCompareArrows, Calculator, Trophy, MapPin, Activity,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { path: "/zip-lookup",          label: "Zip Lookup",      icon: MapPin },
  { path: "/market-activity",  label: "Market Activity", icon: Activity },
